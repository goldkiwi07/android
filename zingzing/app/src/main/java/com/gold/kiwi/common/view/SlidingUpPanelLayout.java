...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        LOG.d(TAG,"!!!!!!!!!!!!!!!!!!!!!!!!!!"+widthMeasureSpec +"//" + heightMeasureSpec + "//"+getChildCount());
        ...
        LOG.d(TAG,widthSize +"//" + heightSize + "//"+getPaddingTop() + "//"+getPaddingLeft() + "//"+getPaddingRight() + "//"+getPaddingBottom());
        LOG.d(TAG,layoutHeight +"//" + layoutWidth);
